        ...
        <div class="container">
            <section class="header__content">
                ...
                <ul class="navigation">
                    ...
                    <li><a class="navigation__item" href=<?php echo url_for("/inc/signin.php") ?>><i class="fas fa-user-alt"></i><span id="id_login-title">
                    ...
                    <?php while ($category = mysqli_fetch_assoc($categories)) {
                        ...
                        <li class="navigation__item--hover">
                            ...
                            <ul class="navigation__sub-list">
                                ...
                                ?>
                                    <li><a href=<?php echo url_for("/inc/collection.php?collection_id=" . secure_http($collection[COLLECTION_ID])) ?> class="navigation__item"><?= $collection[COLLECTION_NAME]; ?></a>
                                    </li>
                                <?php }; ?>
